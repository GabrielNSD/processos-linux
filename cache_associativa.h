...
struct extractDataMA returnDataMA(unsigned short address)
{
    ...
    unsigned short tag = temp & 65280;     // zera os 8 dígitos menos significativos - 65280 = 1111111100000000
    tag = tag >> 8;                        // remove os 8 zeros menos significativos
    unsigned short conjunto = temp & 248;  // retorna os 8 dígitos menos significativos, zerando os 3 menos significativos - 248 = 11111000
    conjunto = conjunto >> 3;
    return {tag, conjunto};
}
